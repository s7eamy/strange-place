...
@onready var resume_option := $CenterContainer/VBoxOptions/Resume
@onready var controls_label = $ControlsLabel
@onready var pause_options = $CenterContainer
@onready var color_rect = $ColorRect

@onready var nodes_grp1 = [pause_button, controls_label] # should be visible during gamemplay and hidden during pause
